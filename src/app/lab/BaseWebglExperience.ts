...
import { ACESFilmicToneMapping, Clock, PerspectiveCamera, Scene, Vector3, WebGLRenderer } from 'three';
...
class BaseWebglExperience {
    ...
    constructor(canvas: HTMLCanvasElement, rendererParams: WebGLRendererParameters = {}) {
...
export default BaseWebglExperience;
