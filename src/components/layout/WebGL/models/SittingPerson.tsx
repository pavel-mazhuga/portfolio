...
function SittingPerson(props: JSX.IntrinsicElements['group']) {
    const { nodes, materials } = useGLTF('/gltf/sitting-person-transformed.glb') as GLTFResult;
    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh
                geometry={nodes.rp_carla_rigged_001_geo_rp_carla_rigged_001_mat_0.geometry}
                material={materials.black}
                scale={0.04}
            />
        </group>
