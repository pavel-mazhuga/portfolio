...
export const mod289_0 = /*#__PURE__*/ Fn(([x_immutable]: [Node<'vec3'>], _builder: NodeBuilder) => {
...
export const mod289_1 = /*#__PURE__*/ Fn(([x_immutable]: [Node<'vec4'>], _builder: NodeBuilder) => {
...
export const mod289 = /*#__PURE__*/ overloadingFn([mod289_0, mod289_1] as unknown as Node[]);
...
export const snoise = /*#__PURE__*/ Fn(([v_immutable]: [Node<'vec3'>], _builder: NodeBuilder) => {
...
export const snoiseVec3 = /*#__PURE__*/ Fn(([x_immutable]: [Node<'vec3'>], _builder: NodeBuilder) => {
    const x = vec3(x_immutable).toVar();
...
export const curlNoise = /*#__PURE__*/ Fn(([p_immutable]: [Node<'vec3'>], _builder: NodeBuilder) => {
