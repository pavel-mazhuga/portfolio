...
export const permute = /*#__PURE__*/ Fn(([x_immutable]: [Node<'vec4'>], _builder: NodeBuilder) => {
...
export const taylorInvSqrt = /*#__PURE__*/ Fn(([r_immutable]: [Node<'vec4'>], _builder: NodeBuilder) => {
...
export const fade = /*#__PURE__*/ Fn(([t_immutable]: [Node<'vec3'>], _builder: NodeBuilder) => {
...
export const cnoise3d = /*#__PURE__*/ Fn(([P_immutable]: [Node<'vec3'>], _builder: NodeBuilder) => {
    ...
    const sz0 = vec4((step as (e: unknown, x: unknown) => ReturnType<typeof step>)(gz0, vec4(float(0)))).toVar();
    const stepGx0 = (step as (e: unknown, x: unknown) => ReturnType<typeof step>)(float(0), gx0);
    const stepGy0 = (step as (e: unknown, x: unknown) => ReturnType<typeof step>)(float(0), gy0);

    gx0.subAssign(sz0.mul(stepGx0.sub(0.5)));
    gy0.subAssign(sz0.mul(stepGy0.sub(0.5)));
    ...
    const sz1 = vec4((step as (e: unknown, x: unknown) => ReturnType<typeof step>)(gz1, vec4(float(0)))).toVar();
    const stepGx1 = (step as (e: unknown, x: unknown) => ReturnType<typeof step>)(float(0), gx1);
    const stepGy1 = (step as (e: unknown, x: unknown) => ReturnType<typeof step>)(float(0), gy1);

    gx1.subAssign(sz1.mul(stepGx1.sub(0.5)));
    gy1.subAssign(sz1.mul(stepGy1.sub(0.5)));
