...
class FlowmapDemo extends BaseExperience {
    ...
    constructor(canvas: HTMLCanvasElement) {
        ...
        this.flowmapPixelMode.value = FLOWMAP_DEFAULTS.isPixel;
        this.flowmapPixel.value = FLOWMAP_DEFAULTS.pixel;
        this.flowmapRgbShift.value = FLOWMAP_DEFAULTS.rgbShift;
        this.flowmapRgbShiftStrength.value = FLOWMAP_DEFAULTS.rgbShiftStrength;
        this.flowmapShowMotion.value = FLOWMAP_DEFAULTS.showMotion;
    ...
    async render() {
        ...
        if (this.params.flowmap.enabled) {
            ...
            this.flowmapPixelMode.value = this.params.flowmap.isPixel;
            this.flowmapPixel.value = this.params.flowmap.pixel;
            this.flowmapRgbShift.value = this.params.flowmap.rgbShift;
            this.flowmapRgbShiftStrength.value = this.params.flowmap.rgbShiftStrength;
            this.flowmapShowMotion.value = this.params.flowmap.showMotion;
        }
