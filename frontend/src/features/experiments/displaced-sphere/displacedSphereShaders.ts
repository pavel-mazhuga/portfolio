/** Inlined GLSL (no glslify / external .glsl imports). Classic 3D noise from glsl-noise (MIT). */
...
void main() {
    ...
    float displacement = cnoise((position + uTime * 0.4) * 2. + (sin(uTime * 0.7) * 0.)) * noiseMult;
