...
const experimentData: ExperimentInput[] = [
...

    {
        ...
        seoDescription:
            'Organic metaball blobs raymarched in real time. WebGPU SDF scene built with Three.js TSL.',
    },
    {
        ...
        tags: ['webgpu', 'tsl', 'shaders', 'particles'],
        seoDescription:
            'Mesh shatters into thousands of GPU particles on interaction. WebGPU TSL destruction effect.',
    },
    {
        name: 'Dissolve',
        slug: 'dissolve',
        tags: ['webgpu', 'tsl', 'shaders', 'particles'],
        seoDescription:
            'Dissolve transition on a particle mesh using custom TSL shaders. WebGPU Three.js lab demo.',
    },
    {
        ...
        seoDescription:
            'Particles spiral into a gravitational black hole. Classic WebGL GLSL particle simulation.',
    },
    {
        name: 'Snowflakes',
        slug: 'snowflakes',
    ...
    },
    {
        ...
        seoDescription:
            'Reusable TSL node material you can extend for custom WebGPU shading pipelines in Three.js.',
    },
    {
        ...
        seoDescription:
            'Click to morph GPU particles between 3D shapes. WebGPU compute shaders and TSL.',
        tip: 'Click',
    },
    {
        name: 'Magic wand',
        ...
        seoDescription:
            'Sparkling magic wand trail follows the pointer. WebGPU compute particle cursor effect.',
    },
    {
        name: 'Flow field',
        slug: 'flow-field',
        tags: ['webgpu', 'tsl', 'shaders', 'compute'],
        seoDescription:
            'Particles flow along a vector field simulation. WebGPU compute shaders with TSL.',
    },
    {
        name: 'Flowmap',
        slug: 'flowmap',
        ...
        seoDescription:
            'Cursor-driven flowmap distorts a reflective scene floor. WebGPU post-processing with TSL.',
        tip: 'Move cursor',
        active: false,
    },
    {
        ...
        seoDescription:
            "Recreation of Nightingale's hover wave image reveal. WebGPU TSL shader effect.",
        tip: 'Click',
    },
    {
        name: 'Infinite water',
        ...
        tags: ['webgpu', 'tsl', 'shaders'],
        seoDescription:
            'Infinitely scrolling procedural water surface. Scroll to move; WebGPU TSL shaders.',
        tip: 'Scroll',
    },
    {
        ...
        seoDescription:
            'GPGPU particle cloud twisted by shader forces. WebGPU compute experiment.',
    },
    {
        ...
        seoDescription:
            'FBO particle swarm tracks cursor position in 3D. WebGL framebuffer simulation.',
    },
    {
        ...
        seoDescription:
            'Vertex-displaced sphere with an extended Three.js custom shader material. WebGL demo.',
    },
    {
        ...
        tags: ['webgl', 'shaders', 'displacement'],
        seoDescription:
            'Second take on procedural sphere vertex displacement. WebGL GLSL shading experiment.',
    },
    {
        ...
        tags: ['webgl', 'shaders', 'particles'],
        seoDescription:
            'Mouse leaves a trail of photo-textured particles. WebGL shader experiment.',
    },
    {
        ...
        tags: ['webgl', 'shaders', 'particles'],
        seoDescription:
            'Particles assemble into a 3D model silhouette. WebGL GLSL particle system.',
    },
    {
        ...
        tags: ['webgl', 'shaders', 'particles'],
        seoDescription:
            'GPU particles morph between targets via framebuffer objects. WebGL FBO technique.',
    },
    {
        name: 'FBO particles',
        slug: 'fbo-particles',
        tags: ['webgl', 'shaders', 'particles'],
        seoDescription:
            'Particle simulation rendered through framebuffer objects. WebGL GPGPU basics.',
    },
    {
        name: 'GPU particles',
        slug: 'gpu-particles',
        tags: ['webgl', 'shaders', 'particles'],
        seoDescription:
            'GPU-accelerated particle field with shader-driven motion. WebGL experiment.',
    },
    {
        ...
        tags: ['webgl', 'shaders', 'displacement'],
        seoDescription:
            'Procedural vertex displacement on a sphere mesh. WebGL custom shader material.',
    },
    {
        ...
        seoDescription:
            'Scroll-driven UV distortion on image planes. WebGL slider shader experiment.',
    },
    {
        ...
        seoDescription:
            'Ripple-wave shader transition between two images. WebGL displacement transition.',
    },
    {
        ...
        tags: ['webgl', 'shaders', 'displacement'],
        seoDescription:
            'Animated sine waves displace mesh vertices in the vertex shader. WebGL demo.',
    },
    {
        name: 'Endless',
        slug: 'endless-1',
        tags: ['webgl', 'shaders'],
        seoDescription:
            'Looping fractal feedback shader with endless color motion. WebGL fullscreen fragment shader.',
    },
    {
        ...
        tags: ['webgl', 'shaders'],
        seoDescription:
            'Infinite UV scroll mapped onto a sphere surface. WebGL texture animation shader.',
    },
    {
        ...
        seoDescription:
            'GPU particles sampled and rendered on a 3D model surface. WebGL experiment.',
    },
    {
        name: 'Flower-ish',
        slug: 'flower-ish',
        tags: ['webgl', 'shaders', 'displacement'],
        seoDescription:
            'Procedural flower-like torus via smooth modular vertex displacement. WebGL shaders.',
    },
    {
        ...
        seoDescription:
            'Glass-like refraction with chromatic dispersion in a WebGL shader scene.',
    },
    {
        name: 'Animated blob',
        slug: 'animated-blob',
        tags: ['webgl', 'shaders'],
        seoDescription:
            'Soft animated blob with smooth organic motion. WebGL vertex and fragment shaders.',
    },
    {
        ...
        tags: ['webgl', 'shaders'],
        seoDescription:
            'Noise-displaced torus knot with custom GLSL materials. WebGL shading experiment.',
    },
    {
        name: 'Plane wave',
        slug: 'plane-wave',
        tags: ['webgl', 'shaders'],
        seoDescription:
            'Rippling wave animation across a plane mesh. WebGL vertex shader experiment.',
    },
];
